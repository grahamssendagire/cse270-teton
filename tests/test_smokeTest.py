...
class TestSmokeTest():
  ...
  def test_smoke(self):
    ...
    self.driver.set_window_size(1267, 629)
    ...
    assert len(elements) > 0
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".main-join > h3")
    assert len(elements) > 0
    ...
    self.driver.find_element(By.LINK_TEXT, "Directory").click()
    self.driver.find_element(By.ID, "directory-grid").click()
    self.driver.find_element(By.CSS_SELECTOR, "section:nth-child(8)").click()
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("graham")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("ssendagire")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("rrrrrrr")
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("freeee")
